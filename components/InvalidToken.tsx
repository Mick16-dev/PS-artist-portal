...
export function InvalidToken({ promoterEmail }: InvalidTokenProps) {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center antialiased">
      ...
      <div className="max-w-md w-full bg-red-50 rounded-3xl p-10 border border-red-100 flex flex-col items-center">
        <div className="w-16 h-16 bg-red-100 rounded-2xl flex items-center justify-center text-red-600 mb-6 transition-transform hover:scale-105">
          <AlertCircle size={32} />
        </div>
        
        <h1 className="text-2xl font-extrabold text-gray-900 mb-4 tracking-tight">This link is not valid</h1>
