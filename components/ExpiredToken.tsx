...
export function ExpiredToken({ expiresAt, promoterEmail }: ExpiredTokenProps) {
  const expiredDate = format(new Date(expiresAt), 'MMMM d, yyyy')
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 max-w-md w-full text-center">
        ...
        <p className="text-gray-500 leading-relaxed mb-8">
          Your portal link expired on <strong>{expiredDate}</strong>. Please contact your promoter to send you a new link.
        </p>
        {promoterEmail ? (
          <a
          ...
          <p className="text-gray-400 text-sm">Please reach out to your promoter directly.</p>
        )}
      </div>
